...
/**
 * GroundType form base class.
 *
 * @method GroundType getObject() Returns the current form's model object
 *
 * @package    marina
 * @subpackage form
 ...
 */
abstract class BaseGroundTypeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'GroundType', 'column' => array('name')))
    );

    $this->widgetSchema->setNameFormat('ground_type[%s]');
